...
#
# CONTRACT: viin_brand_web must ship NO deprecated QWeb directive (t-esc / t-raw) in its own
...
class TitleDebrandSourceGuardTest(TransactionCase):
    ...
    def test_module_views_ship_no_deprecated_qweb_directive(self):
        ...
        self.assertFalse(
            offenders,
            "viin_brand_web ships a deprecated QWeb directive in its own view data; use the "
